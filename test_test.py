...
total_games_count = 1792

@pytest.mark.count
def test_count_all_games(browser, timeout=30):
    game_page = GamesPage(browser, "https://poker.evenbetpoker.com/html5/", timeout=timeout)
    game_page.open()
    game_page.go_to_games()
    global total_games_count
    total_games_count = game_page.count_all_games()

@pytest.mark.count
def test_print_total_games_count():
